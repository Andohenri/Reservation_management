   ...
   return (
      <form onSubmit={handleUpdate || handleCreate} className='shadow-md rounded-lg p-4'>
         <div className='mb-4'>
            ...
            <input className='input' type="text" name="name" id="name" defaultValue={trainForm?.name || ''} onChange={handleChange} required/>
         </div>
         <div className='mb-4'>
            <label className='label' htmlFor="type">Type</label>
            <input className='input' type="text" name="type" id="type" defaultValue={trainForm?.type || ''} onChange={handleChange} required/>
         </div>
         <div className='mb-6 w-full'>
            <label className='label' htmlFor="capacity">Capacité</label>
            <input className='input' type="number" name="capacity" id="capacity" defaultValue={trainForm?.capacity || ''} onChange={handleChange} required/>
         </div>
